    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div>
            <div class="col-md-6 offset-md-3">
                <br>
                <a href="{{route('login.google')}}" class="btn btn-blue btn-block" style="color:white">Login with Google</a> <br>
                <a href="{{route('login.facebook')}}" class="btn btn-primary btn-block" style="color:white">Login with Facebook</a>
            </div>
        </div>
